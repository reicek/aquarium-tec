...
- The repo does not yet contain the final formal 2D release drawing for the stainless wet part.
- That is acceptable at the current project stage because the hose-fit coupon validation gate is still open.
...
- The final stainless release remains intentionally gated on validation and a later formal drawing package.